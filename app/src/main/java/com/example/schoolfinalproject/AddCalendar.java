...
public class AddCalendar extends AppCompatActivity implements EasyPermissions.PermissionCallbacks
{
        ...
        public void onClick(View view)
        {
            switch(view.getId())
            {
                ...
                case R.id.endDateSettingText://dateSetting:
                    ...
                    DatePickerDialog endDateDialog = new DatePickerDialog(AddCalendar.this, callbackEnd_date, Syear, Smonth-1, Sday);
                    endDateDialog.show();

                    break;
                case R.id.startTimeSettingText:
                    TimePickerDialog startTimeDialog = new TimePickerDialog(AddCalendar.this, 2, callbackStart_time, Shour, Sminute, false);
                    startTimeDialog.show();

                    break;
                case R.id.endTimeSettingText:
                    TimePickerDialog endTimeDialog = new TimePickerDialog(AddCalendar.this, 2, callbackEnd_time, Shour, Sminute, false);
                    endTimeDialog.show();
...
/*
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, String> {
        ...
        private AddCalendar mActivity;
        List<String> eventStrings = new ArrayList<String>();



        public MakeRequestTask(AddCalendar activity, GoogleAccountCredential credential) {
